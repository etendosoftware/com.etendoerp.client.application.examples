...
public class ExampleComponentProvider extends BaseComponentProvider {
  ...
  public List<ComponentResource> getGlobalComponentResources() {
    ...
    globalResources.add(createStaticResource(
        "web/com.etendoerp.client.application.examples/js/example-canvas-field.js", false));
    globalResources.add(createStaticResource(
        "web/com.etendoerp.client.application.examples/js/example-view-component.js", false));
    globalResources.add(createStaticResource(
        "web/com.etendoerp.client.application.examples/js/example-grid-view.js", false));
    globalResources.add(createStaticResource(
        "web/com.etendoerp.client.application.examples/js/example-simple-view.js", false));
    globalResources.add(createStaticResource(
        "web/com.etendoerp.client.application.examples/js/example-toolbar-button.js", false));
    globalResources.add(createStaticResource(
        "web/com.etendoerp.client.application.examples/js/example-onchange.js", false));
    globalResources.add(createStaticResource(
        "web/com.etendoerp.client.application.examples/js/example-pick-and-execute.js", false));
    globalResources.add(createStaticResource(
        "web/com.etendoerp.client.application.examples/js/example-manual-process.js", false));
    globalResources
